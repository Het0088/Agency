const testimonials = [
  ...
  { stars: '★★★★★', q: '"We\'ve worked with three SEO agencies before. We Strive is the first one that felt like a partner instead of a vendor sending PDFs into the void."', name: 'James Okafor', role: 'CMO · Northbound Analytics', initial: 'J', feature: true },
