export default function HomeFaq({ content }: { content?: Record<string, string> }) {
  const faqs = [
    ...
    { q: content?.faq_6_q || 'What makes Gen Ranq different from other SEO agencies?', a: content?.faq_6_a || 'We optimize for both traditional search and AI-driven retrieval. Most agencies still focus only on Google rankings. We ensure your brand is cited in ChatGPT, Perplexity, and Google AI Overviews alongside traditional organic results.' },
